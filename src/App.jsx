          ...
          <div className="container hero-grid">
            <div className="hero-copy">
              ...
              <p className="hero-text">
                ...
                trusted service, and practical guidance for homeowners,
                landowners, and commercial customers across northeastern North
                Carolina.
              </p>
                ...
                <div className="hero-card-inner">
                  ...
                  <div className="hero-feature-grid">
                    <div className="hero-feature hero-feature-dark">
                      <p className="feature-label feature-label-light">
                        Veteran-Owned
                      </p>
                      <p className="feature-text feature-text-light">
                        Leadership shaped by service, integrity, and
                        follow-through.
                      </p>
                    </div>
                    ...
                    <div className="hero-feature hero-feature-light">
                      ...
                      <p className="feature-text">
                        Real equipment knowledge that helps customers make
                        confident decisions.
                      </p>
                    </div>
                    ...
                    <div className="hero-feature hero-feature-light hero-feature-wide">
                      ...
                      <p className="feature-text">
                        Sales, service, and support from a team that understands
                        how equipment needs to perform in the real world.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="container">
            <div className="section-intro max-copy">
              ...
              <h2 className="section-title">
                Your Local Source for Bad Boy Mowers, Service & Equipment
              </h2>
        ...
        <section id="service" className="section section-tint">
          <div className="container split-grid">
            <div>
              ...
              <p className="section-text">
                From routine maintenance to repairs, our service team helps
                protect your investment and reduce downtime when the work still
                needs to get done.
              </p>
            ...
            <div className="service-panel">
              ...
              <div className="service-form">
                ...
                />
                <button className="button button-light form-button">
                  Submit Request
                </button>
              </div>
            </div>
        ...
        <section id="about-us" className="section">
          <div className="container">
            <div className="section-intro max-copy-wide">
              ...
              <h3 className="section-title">
                A practical team built on service and experience
              </h3>
              <p className="section-text">
                Intercoastal Outdoor Equipment is built around dependable
                equipment, straightforward service, and helping customers make
                smart decisions without the runaround. We serve homeowners,
                landowners, and businesses that need equipment ready to work.
              </p>
            </div>
          ...
          <div className="container split-grid contact-grid">
            <div>
              ...
              <h3 className="section-title section-title-light">
                Ready to find your next piece of equipment?
              </h3>
              <p className="section-text section-text-light">
                Reach out for current inventory, service scheduling, or general
                questions. We are here to help you get the right equipment and
                support.
              </p>
            </div>
            ...
            <div className="contact-card">
              ...
              <div>
                ...
                <p className="contact-value">
                  info@intercoastaloutdoorequipment.com
                </p>
              </div>
            </div>
          </div>
